...
$appSettings = @(
    ...
    "PROCESSING_RELEVANCE_THRESHOLD=2",
    "PROCESSING_SIMILARITY_THRESHOLD=0.55",
    "PROCESSING_CONNECTION_CONFIDENCE_THRESHOLD=0.4",
    "PROCESSING_MAX_AGENT_SEARCHES=5",
    "PROCESSING_TEMPORAL_WINDOW_DAYS=180",
    "PROCESSING_MAX_CONNECTION_CANDIDATES_PER_TICKER=50"
)
